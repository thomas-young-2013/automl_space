...
datasets = 'wind,delta_ailerons,puma8NH,kin8nm,cpu_small,puma32H,cpu_act,bank32nh,mc1,delta_elevators'
datasets = datasets.split(',')

space_size_list = ['large']
algo_list = ['lightgbm', 'random_forest']    # 'adaboost', 'extra_trees'
max_run = 200
